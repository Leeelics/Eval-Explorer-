        ...
        {!selectedItem && !selectedModel && (
          <div className="flex gap-4 mb-10 justify-center">
            <button 
              ...
              className={`px-8 py-3 rounded-2xl font-bold text-sm transition-all ${activeTab === 'research' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 hover:text-white bg-slate-800/50'}`}
            >
              Research & Datasets
            </button>
            <button 
              onClick={() => setActiveTab('models')}
              className={`px-8 py-3 rounded-2xl font-bold text-sm transition-all ${activeTab === 'models' ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 hover:text-white bg-slate-800/50'}`}
            >
              Models Ecosystem
            </button>
          </div>
                ...
                <div className="glass-card rounded-2xl p-6 border border-white/5 shadow-2xl shadow-blue-500/5">
                  ...
                  <div className="space-y-4 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-white">{items.reduce((acc, curr) => acc + (curr.citationCount || 0), 0).toLocaleString()}</span>
                    </div>
                  </div>
                </div>
              </div>
